...
const MissionControlPanel = () => {
  ...
  const { isMotorMode, isCoordMode, isVertexMode, showAmount } = updateControlVisibility();
      ...
      <CardContent className="space-y-6 text-white">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <div className={`w-3 h-3 rounded-full ${getIndicatorColor(goalColor)}`}></div>
              <span className={`text-base font-medium ${getStatusColor(goalColor)}`}>
                {goalStatus}
              </span>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-1 gap-3">
            <Button 
              ...
              className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium py-2 text-base"
            >
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-2 text-base"
            >
            ...
            <Button 
              onClick={handleStop}
              variant="outline" 
              className="w-full border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-medium py-2 text-base"
            >
