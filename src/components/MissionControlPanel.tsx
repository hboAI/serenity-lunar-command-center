...
const MissionControlPanel = () => {
  ...
  return (
    <Card className="h-full bg-black/30 backdrop-blur-xl border border-white/20 shadow-2xl">
      ...
      <CardContent className="space-y-4 text-sm">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedMode} onValueChange={setSelectedMode}>
            ...
            <SelectContent className="bg-black/90 border-white/30">
              {modes.map((mode) => (
                <SelectItem key={mode.value} value={mode.value} className="text-white text-xs py-2">
                  {mode.label}
                </SelectItem>
              ))}
            </SelectContent>
        ...
        {isMotorMode && (
          <div className="space-y-3">
            ...
            <Input
              ...
              className="bg-black/40 border-white/30 text-white h-8 text-sm"
            />
        ...
        <div className="space-y-2">
          <Button 
            ...
            className="w-full text-sm py-4 bg-gradient-to-r from-space-cyan to-space-blue hover:from-space-blue hover:to-space-cyan"
          >
            Execute Command
          </Button>
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button 
              ...
              variant="outline"
              className="text-xs py-2 bg-black/20 border-green-500/50 text-green-400 hover:bg-green-500/20"
            >
            ...
            <Button 
              ...
              variant="outline"
              className="text-xs py-2 bg-black/20 border-red-500/50 text-red-400 hover:bg-red-500/20"
            >
