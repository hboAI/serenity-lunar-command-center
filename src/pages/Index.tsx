  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-20">
        <img 
          alt="Serenity Logo" 
          src="/lovable-uploads/5bdfc386-c196-4f88-9303-fe4a0ce7c808.png" 
          className="h-16 opacity-70 hover:opacity-100 transition-opacity duration-300 object-contain filter brightness-0 invert" 
        />
      </div>
